...
relatedPatterns: ["proactivity-injection", "bounded-autonomy", "feedback-loop-via-memory", "idempotent-cron-session-isolation", "dedup-search-before-filing", "convergence-stall-detection", "tool-error-triage", "graceful-capability-degradation"]

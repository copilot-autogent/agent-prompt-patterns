...
relatedPatterns: ["deploy-lag-verification", "side-effect-verification", "empirical-validation-loop", "sprint-completion-verification", "ssr-prerender-component-guard", "dependent-sweep-before-delete", "delta-anchored-verification"]

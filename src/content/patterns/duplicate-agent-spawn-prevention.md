...
relatedPatterns: ["staggered-task-spawning", "sprint-continuity", "dispatcher-pattern", "side-effect-verification", "circuit-breaker", "workspace-per-sprint-isolation", "sprint-completion-verification", "idempotent-cron-session-isolation"]

...
**arXiv 2406.03853:** Cited in the pattern specification as reporting "in-context exemplars reduce format violation rates by 40–60% versus prose-only specifications in structured generation tasks." The precise figures should be verified against the source; the directional claim (exemplars outperform prose-only specs) is consistent with the autogent sprint observations above.

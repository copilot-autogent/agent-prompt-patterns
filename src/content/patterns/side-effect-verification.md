...
relatedPatterns: ["pre-commit-planning-phase", "observer-actor-separation", "sprint-continuity", "workspace-per-sprint-isolation", "sprint-completion-verification", "deploy-lag-verification"]

...
relatedPatterns: ["feedback-loop-via-memory", "context-window-budgeting", "pre-commit-planning-phase", "workspace-per-sprint-isolation", "deploy-lag-verification", "long-horizon-task-phasing"]

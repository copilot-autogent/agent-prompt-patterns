...
relatedPatterns: ["staggered-task-spawning", "duplicate-agent-spawn-prevention", "sprint-continuity", "side-effect-verification", "sprint-completion-verification", "long-horizon-task-phasing", "execution-budget-aware-dispatch"]
